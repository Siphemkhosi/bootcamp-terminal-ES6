...
import mostProfitableDepartment from "../mostProfitableDepartment.js";
 ...
 describe('Testing the mostProfitableDepartment function' , function(){
    it('should return outdoor for the most profitable day is salesData' , function(){
        var salesData = [
    ...
    it('should return electronics for the most profitable day in salesData2' , function(){
    ...
    it("should return  electronics instead of steelwork" , function () {
        var salesData2 = [
            {department : 'electronics', sales : 4500, day : 'Monday'},
            {department : 'outdoor', sales : 1500, day : 'Monday'},
            {department : 'carpentry', sales : 5500, day : 'Monday'},
        ...
        assert.equal("electronics", mostProfitableDepartment(salesData2), "Most profitable department is 'steelwork' for dataset 2");
    });
